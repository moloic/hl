...
{
    public class cloud_componentDal : RepositoryFactory<cloud_component>
    {
        ...
        public DataTable getPageList(cloud_component model)
        {
            ...
            strSql.Append(" from cloud_component a ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT * FROM cloud_component  a  WHERE 1=1");
            strSql.Append(" and  a.IsDeleted= 0  ");
        ...
        public bool Insert(cloud_component model)
        {
            ...
            if (model != null)
            {
                strSql.Append(" INSERT INTO `cloud_component` ");
                strSql.Append(" ( ");
                strSql.Append(" `Id`, ");
                strSql.Append(" `Name`, ");
                strSql.Append(" `State`, ");
        ...
        public bool Update(cloud_component model)
        {
            ...
            if (model != null)
            {
                strSql.Append(" update cloud_component  ");
                strSql.Append(" SET  ");
        ...
        public bool Delete(string Id)
        {
            ...
            bool isok = false;
            StringBuilder strSql = new StringBuilder();
            // strSql.Append("  delete from cloud_component ");
            strSql.Append("  update  cloud_component  set IsDeleted=1  ");
            strSql.Append(" where ");
