...
namespace Hl.dotNet.Repository
{
    ...
    public interface IRepository<T> where T : new()
    {
        ...
        /// <returns></returns>
        int InsertBySql(string strSql, DbTransaction isOpenTrans);
        #endregion
        ...
        /// <param name="isOpenTrans"></param>
        /// <returns></returns>
        int UpdateBySql(string strSql, DbTransaction isOpenTrans);//更新sql语句
        #endregion
        ...
        /// <param name="isOpenTrans"></param>
        /// <returns></returns>
        int DeleteBySql(string strSql, DbTransaction isOpenTrans);
        #endregion
