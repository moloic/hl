...
namespace Hl.dotNet.Repository
{
    public class Repository<T> : IRepository<T> where T : new()
    {
        ...
        /// <returns></returns>
        public int InsertBySql(string strSql, DbTransaction isOpenTrans)
        {
            return DataFactory.Database().InsertBySql(strSql, isOpenTrans);
        }
        ...
        /// <param name="isOpenTrans"></param>
        /// <returns></returns>
        public int UpdateBySql(string strSql, DbTransaction isOpenTrans)
        {
            return DataFactory.Database().UpdateBySql(strSql, isOpenTrans);
        }
        #endregion
        ...
        /// <param name="isOpenTrans"></param>
        /// <returns></returns>
        public int DeleteBySql(string strSql, DbTransaction isOpenTrans)
        {
